...
# 어두 평음(ㄱ·ㄷ·ㅂ·ㅈ)으로 시작하는 도시는 일본어 표기가 청음/탁음으로 흔들림.
# (예: 부산 プサン/ブサン, 대구 テグ/デグ, 광주 クァンジュ/グァンジュ, 제주 チェジュ/ジェジュ)
# 위 표는 청음만 등록돼 있으므로 탁음 표기 별칭을 보강한다.
_JPN_CITY_VOICED_ALIASES: dict[str, str] = {
    "ブサン": "부산", "デグ": "대구", "グァンジュ": "광주",
    "ギョンジュ": "경주", "グミ": "구미", "ゴリョン": "고령", "ギムチョン": "김천",
    "ゴジェ": "거제", "ジンジュ": "진주", "ギムヘ": "김해",
    "ジョンジュ": "전주", "グンサン": "군산", "ジョンウプ": "정읍", "ブアン": "부안",
    "ジャンス": "장수", "ジナン": "진안", "ギムジェ": "김제",
    "ダミャン": "담양", "ガンジン": "강진", "ゴフン": "고흥", "ゴクソン": "곡성",
    "グァンヤン": "광양", "グリェ": "구례", "ボソン": "보성", "ジャンソン": "장성",
    "ジャンフン": "장흥", "ジンド": "진도", "ジェチョン": "제천", "ダニャン": "단양",
    "ボウン": "보은", "グェサン": "괴산", "ゴンジュ": "공주", "ブヨ": "부여",
    "ボリョン": "보령", "グムサン": "금산", "ダンジン": "당진", "ガンヌン": "강릉",
    "ドンヘ": "동해", "ゴヤン": "고양", "ガピョン": "가평", "ブチョン": "부천",
    "ジェジュ": "제주", "ボンファ": "봉화",
}
_JPN_CITY_TO_KO.update(_JPN_CITY_VOICED_ALIASES)
