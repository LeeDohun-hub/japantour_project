...
이 디렉터리는 **Japan Tour**용 RAG 체인(`src/chain`)의 응답 품질을 Ragas로 측정하기 위한 도구를 제공합니다. (샘플 `test_dataset.json`은 레거시 형식일 수 있으니 관광 도메인으로 교체하는 것을 권장합니다.)
